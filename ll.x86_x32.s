...
#
#  assemble with     "as --x32 -o ll.o ll.x86_x32.s"
#  link with         "ld -melf32_x86_64 -o ll ll.o"

#
# x32 is the 32-bit userspace for 64-bit x86_64 code interface
#
# You can create smaller binaries because pointers are only 32-bits
# and only 32-bits of address space is allowed
#
# Unlike just using i386 binaries under emulation, x32 allows:
#  + Using full 64-bits of registers
#  + Using registers R8-R15
